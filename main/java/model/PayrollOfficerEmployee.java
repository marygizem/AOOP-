...
public class PayrollOfficerEmployee extends RegularEmployee {
    public PayrollOfficerEmployee(double basicSalary, int empID, String lastName, String firstName, Date birtday,
